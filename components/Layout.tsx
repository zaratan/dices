...
const navigation = [
  ...
  { name: 'DnD', href: '/dnd5', current: false },
  { name: 'WoD', href: '/wod', current: false },
...
function Layout({
  ...
  return (
    <div className="min-h-full justify-between flex flex-col">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center">
                  <div className="flex-shrink-0 text-white">ZD</div>
      ...
      <main className="overflow-x-scroll flex-grow">
